...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/technical-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14047&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/technical-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `technical` can be installed with:

```
conda install technical
```

It is possible to list all of the versions of `technical` available on your platform with:
